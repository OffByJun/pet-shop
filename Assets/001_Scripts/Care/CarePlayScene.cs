...
namespace PetShop.Care
{
    ...
    public sealed class CarePlayScene : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            if (view != null)
            {
                view.ToolRequested += SelectTool;
                view.ConditionRequested += SelectCondition;
                view.ResetRequested += ResetCare;
            }
            if (stageInput != null) stageInput.StrokeRequested += ApplyStroke;
        }
