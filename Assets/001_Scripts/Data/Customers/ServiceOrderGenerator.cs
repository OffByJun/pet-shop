...
namespace _001_Scripts.Data.Customers
{
    ...
    public sealed class ServiceOrderGenerator
    {
        ...
        private readonly IProgressionContentAccess contentAccess;

        public ServiceOrderGenerator(
            ServiceOrderCatalog catalog,
            IServiceOrderRandom random = null,
            IProgressionContentAccess contentAccess = null)
        {
        ...
        private bool IsAvailable(string contentId) => contentAccess == null || contentAccess.IsContentUnlocked(contentId);
